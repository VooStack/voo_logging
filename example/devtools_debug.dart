...
void main() async {
  ...
  VooLogger.info('Test 4: VooLogger.info message', category: 'Test');
  VooLogger.error('Test 5: VooLogger.error message', category: 'Test');
  VooLogger.debug('Test 6: VooLogger.debug message', category: 'Test');
