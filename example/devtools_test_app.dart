...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _generateLogs() {
    ...
    VooLogger.info('User interaction logged', category: 'Analytics', metadata: {
      'action': 'button_press',
      'counter': _counter,
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('VooLogger DevTools Test'),
      ),
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            const Text(
              'Press the button to generate logs.',
            ...
            const Text(
              'Voo Logger tab to see the logs.',
